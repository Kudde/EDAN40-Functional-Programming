...
import Statement
p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15 :: Statement.T
p1 = fromString "skip;"
...
p12 = fromString "m := 2^3^4;"
p13 = fromString "read -- input a value\n-- into variable b:\nb;"
p14 = fromString "read b;"
p15 = fromString "read -- hej \n b;"
